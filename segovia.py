...
class Segovia():
    def __init__(self, x, y):
        ...
        self.animaciones = [
            pygame.image.load("assets/images/character/Npc/Prof.Segovia/Segovia_1.png"),
            pygame.image.load("assets/images/character/Npc/Prof.Segovia/Segovia_2.png"),
            pygame.image.load("assets/images/character/Npc/Prof.Segovia/Segovia_3.png"),
            pygame.image.load("assets/images/character/Npc/Prof.Segovia/Segovia_4.png"),
        ]

        for i in range(len(self.animaciones)):
            self.animaciones[i] = pygame.transform.scale(
                self.animaciones[i],
                (int(constantes.ANCHO_PERSONAJE * 1.5), int(constantes.ALTO_PERSONAJE * 1.5))
            )
